...
import cmu.s3d.ltl.Fluent
import cmu.s3d.ltl.Word
import cmu.s3d.ltl.evaluateFluent
...
class GR1InvariantWeakener(
    ...
    private val positiveExamples: List<Word>,
    private val negativeExamples: List<Word>,
    ...
    fun learn(): LTLLearningSolution? {
        ...
        val ltlLearner = LTLLearner(
            ...
            positiveExamples = positiveExamples.map { evaluateFluent(it, fluents) },
            negativeExamples = negativeExamples.map { evaluateFluent(it, fluents) },
